...
const usersUrl = "http://1b64719a.ngrok.io/api/v1/users";
const loginUrl = "http://1b64719a.ngrok.io/api/v1/login";
...
export const fetchArtistAlbums = (spotifyToken, id, country) => fetch(`https://api.spotify.com/v1/artists/${id}/albums?limit=20&include_groups=album&market=${country}`, {
